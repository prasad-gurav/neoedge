...
function UserIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      />
      <path
        d="M5 20v-1.2c0-2.2 2.4-3.6 7-3.6s7 1.4 7 3.6V20"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
...
export function SignupPage() {
  ...
  return (
    <div>
      ...
      <p className="auth-form__subtitle">Join Neoedge and start in minutes</p>
      ...
      <form onSubmit={onSubmit} noValidate>
        <div>
          <label className="auth-field__label" htmlFor={fullNameId}>
            Full name
          </label>
